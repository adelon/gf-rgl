    ...
    *,
    ...
    lines = [
        ...
        *_markdown_table(
        ...
        f"{max(int(primary_checks['fitting.peak_rss_kib']['observed']), int(repeat_checks['fitting.peak_rss_kib']['observed']))} KiB RSS, and at most",
        f"{max(int(primary_checks['fitting.disposable_artifact_bytes']['observed']), int(repeat_checks['fitting.disposable_artifact_bytes']['observed']))} disposable bytes,",
