...
concrete DictGer of DictGerAbs =
  MorphoDictGer -
    ...
    , analytische_sprache_N
    , ausgestorbene_sprache_N
    , baltische_sprache_N
    , germanische_sprache_N
    , iranische_sprache_N
    , keltische_sprache_N
...
lin abgeltungssteuer_N = mkN "Abgeltungs" steuer_steuer_N ;
lin abgeltungsteuer_N = mkN abgeltung_N steuer_steuer_N ;
lin abgasanalysator_N = mkN abgas_N analysator_N ;
lin abfuehrmittel_N = mkN "Abführ" mittel_N ;
...
lin abhaengigkeitsgrammatik_N = mkN "Abhängigkeits" grammatik_N ;
lin abkehrschein_N = mkN "Abkehr" schein_N ;
lin abklingbecken_N = mkN "Abkling" becken_N ;
lin abkuerzungsfimmel_N = mkN "Abkürzungs" fimmel_N ;
lin abkuerzungssprache_N = changeCompoundN "Abkürzungssprachen" (mkN "Abkürzungs" sprache_N) ;
lin abkuerzungsverzeichnis_N = mkN "Abkürzungs" verzeichnis_N ;
lin abkuerzungswoerterbuch_N = mkN "Abkürzungs" woerterbuch_N ;
...
lin ablenkungsmanoever_N = mkN "Ablenkungs" manoever_N ;
lin abrasionsplatte_N = mkN "Abrasions" platte_N ;
lin abrissbirne_N = changeCompoundN "Abrissbirnen" (mkN abriss_N birne_N) ;
lin abnuetzungserscheinung_N = mkN abnuetzung_N erscheinung_N ;
lin abnutzungserscheinung_N = mkN abnutzung_N erscheinung_N ;
lin abschiedsausgabe_N = mkN "Abschieds" ausgabe_N ;
lin abschiedsfeier_N = mkN "Abschieds" feier_N ;
lin abschiedsgrussformel_N = mkN "Abschieds" grussformel_N ;
lin abschiedskuss_N = mkN "Abschieds" kuss_N ;
lin abschlagsmarkierung_N = mkN "Abschlags" markierung_N ;
lin abschleppdienst_N = mkN "Abschlepp" dienst_N ;
lin abschleppseil_N = mkN "Abschlepp" seil_N ;
lin abschleppstange_N = mkN "Abschlepp" stange_N ;
lin absatzproblem_N = mkN absatz_N problem_N ;
lin absatzzeichen_N = mkN absatz_N zeichen_N ;
lin absauganlage_N = mkN "Absaug" anlage_N ;
lin abschlussarbeit_N = mkN abschluss_N arbeit_N ;
lin abschlusspruefung_N = mkN abschluss_N pruefung_N ;
lin abschlusszeugnis_N = mkN abschluss_N zeugnis_N ;
lin abschussbasis_N = mkN abschuss_N basis_N ;
lin abschussbefehl_N = mkN abschuss_N befehl_N ;
lin abschussliste_N = mkN abschuss_N liste_N ;
lin abschussrampe_N = mkN abschuss_N rampe_N ;
lin absichtserklaerung_N = mkN "Absichts" erklaerung_N ;
lin absorptionsspektrum_N = mkN "Absorptions" spektrum_N ;
lin abstandsprache_N = changeCompoundN "Abstandsprachen" (mkN "Abstand" sprache_N) ;
lin abseitsfalle_N = mkN "Abseits" falle_N ;
lin abseitstor_N = changeCompoundN "Abseitstor" (mkN "Abseits" tor_N) ;
lin absperrbalken_N = mkN "Absperr" balken_N ;
lin abstellgleis_N = mkN "Abstell" gleis_N ;
lin abstellkammer_N = mkN "Abstell" kammer_N ;
lin abstellraum_N = mkN "Abstell" raum_N ;
lin abstiegsplatz_N = mkN "Abstiegs" platz_N ;
lin abstimmungsgebiet_N = mkN abstimmung_N gebiet_N ;
lin abstraktionsfaehigkeit_N = mkN "Abstraktions" faehigkeit_N ;
lin abstrichprobe_N = changeCompoundN "Abstrichproben" (mkN "Abstrich" probe_N) ;
lin abwaermekraftwerk_N = mkN "Abwärme" kraftwerk_N ;
lin abwehrkette_N = mkN "Abwehr" kette_N ;
lin abwehrkraft_N = mkN "Abwehr" kraft_N ;
lin abwehrverletzung_N = mkN "Abwehr" verletzung_N ;
lin abwrackpraemie_N = mkN "Abwrack" praemie_N ;
lin abziehstahl_N = mkN "Abzieh" stahl_N ;
lin abzweigdose_N = mkN "Abzweig" dose_N ;
lin ackerbuergerhaus_N = mkN "Ackerbürger" haus_N ;
lin achselhaar_N = mkN achsel_N haar_N ;
lin haarfarbe_N = mkN "Haar" farbe_N ;
lin haarschnitt_N = mkN "Haar" schnitt_N ;
lin haargarn_N = mkN "Haar" garn_N ;
lin haarnetz_N = mkN "Haar" netz_N ;
lin haarsieb_N = mkN "Haar" sieb_N ;
lin haarstern_N = mkN "Haar" stern_N ;
lin haaransatz_N = mkN "Haar" ansatz_N ;
lin haarersatz_N = mkN "Haar" ersatz_N ;
...
lin hafenkapitaen_N = mkN "Hafen" kapitaen_N ;
lin hafenstadt_N = mkN "Hafen" stadt_N ;
lin haferfeld_N = mkN "Hafer" feld_N ;
lin haferflocke_N = mkN "Hafer" flocke_N ;
lin hakenkreuz_N = mkN "Haken" kreuz_N ;
lin hakenkreuzfahne_N = mkN hakenkreuz_N fahne_N ;
lin hakennase_N = mkN "Haken" nase_N ;
lin hakenstecken_N = mkN "Haken" stecken_N ;
lin halbaffe_N = mkN "Halb" affe_N ;
lin halbaffix_N = mkN "Halb" affix_N ;
lin halbdackel_N = mkN "Halb" dackel_N ;
lin halbgott_N = mkN "Halb" gott_N ;
lin halbinsel_N = mkN "Halb" insel_N ;
lin halbjahr_N = mkN "Halb" jahr_N ;
lin halbkanton_N = mkN "Halb" kanton_N ;
lin halbkonsonant_N = mkN "Halb" konsonant_N ;
lin halbkreis_N = mkN "Halb" kreis_N ;
lin halbkugel_N = mkN "Halb" kugel_N ;
lin halbmetall_N = mkN "Halb" metall_N ;
lin halbmond_N = mkN "Halb" mond_N ;
lin halbstamm_N = mkN "Halb" stamm_N ;
lin halbsuffix_N = mkN "Halb" suffix_N ;
lin halbvokal_N = mkN "Halb" vokal_N ;
lin halbzeit_N = mkN "Halb" zeit_N ;
lin halbzylinder_N = mkN "Halb" zylinder_N ;
lin hallenbad_N = mkN "Hallen" bad_N ;
lin hallenkirche_N = mkN "Hallen" kirche_N ;
lin hallenkrypta_N = mkN "Hallen" krypta_N ;
lin handarbeit_N = mkN "Hand" arbeit_N ;
lin handball_N = mkN "Hand" ball_N ;
lin handbeil_N = mkN "Hand" beil_N ;
lin handbesen_N = mkN "Hand" besen_N ;
lin handbuch_N = mkN "Hand" buch_N ;
lin handflaeche_N = mkN "Hand" flaeche_N ;
lin handgelenk_N = mkN "Hand" gelenk_N ;
lin handgranate_N = mkN "Hand" granate_N ;
lin handgriff_N = mkN "Hand" griff_N ;
lin handkuss_N = mkN "Hand" kuss_N ;
lin handruecken_N = mkN "Hand" ruecken_N ;
lin handschelle_N = mkN "Hand" schelle_N ;
lin handschlag_N = mkN "Hand" schlag_N ;
lin handschrift_N = mkN "Hand" schrift_N ;
lin handseife_N = mkN "Hand" seife_N ;
lin handspiel_N = mkN "Hand" spiel_N ;
lin handstand_N = mkN "Hand" stand_N ;
lin handtasche_N = mkN "Hand" tasche_N ;
lin handteller_N = mkN "Hand" teller_N ;
lin handtuch_N = mkN "Hand" (mkN "Tuch" "Tücher" neuter) ;
lin handwaesche_N = mkN "Hand" (mkN "Wäsche" "Wäschen" "Wäschen" feminine) ;
lin handwerk_N = mkN "Hand" werk_N ;
lin handwurzel_N = mkN "Hand" wurzel_N ;
lin halskette_N = mkN "Hals" kette_N ;
...
lin hauptakzent_N = mkN "Haupt" akzent_N ;
lin hauptbahnhof_N = mkN "Haupt" bahnhof_N ;
lin hauptbuch_N = mkN "Haupt" buch_N ;
lin hauptfeldwebel_N = mkN "Haupt" feldwebel_N ;
lin hauptgruppe_N = mkN "Haupt" gruppe_N ;
lin haupthaus_N = mkN "Haupt" haus_N ;
lin hauptkomponente_N = mkN "Haupt" komponente_N ;
lin hauptlaster_N = mkN "Haupt" laster_N ;
lin hauptlinie_N = mkN "Haupt" linie_N ;
lin hauptmahlzeit_N = mkN "Haupt" mahlzeit_N ;
lin hauptplatine_N = mkN "Haupt" platine_N ;
lin hauptrolle_N = mkN "Haupt" rolle_N ;
lin hauptsache_N = mkN "Haupt" (mkN "Sache" "Sachen" "Sachen" feminine) ;
lin hauptsatz_N = mkN "Haupt" satz_N ;
lin hauptschluessel_N = mkN "Haupt" schluessel_N ;
lin hauptschnur_N = mkN "Haupt" schnur_N ;
lin hauptseite_N = mkN "Haupt" seite_N ;
lin hauptspeise_N = mkN "Haupt" (mkN "Speise" "Speisen" "Speisen" feminine) ;
lin hauptsprache_N = mkN "Haupt" (mkN "Sprache" "Sprachen" "Sprachen" feminine) ;
lin hauptstadt_N = mkN "Haupt" stadt_N ;
lin hauptstrasse_N = mkN "Haupt" strasse_N ;
lin hauptteil_N = mkN "Haupt" teil_N ;
lin hauptwort_N = mkN "Haupt" wort_N ;
lin hausanschluss_N = mkN "Haus" anschluss_N ;
lin hausarbeit_N = mkN "Haus" arbeit_N ;
lin hausarzt_N = mkN "Haus" arzt_N ;
lin hausaufgabe_N = mkN "Haus" aufgabe_N ;
lin hausbar_N = mkN "Haus" bar_N ;
lin hausbock_N = mkN "Haus" bock_N ;
lin hausbuch_N = mkN "Haus" buch_N ;
lin hausdach_N = mkN "Haus" dach_N ;
lin hauseingang_N = mkN "Haus" eingang_N ;
lin hausente_N = mkN "Haus" ente_N ;
lin hausfrau_N = mkN "Haus" frau_N ;
lin hausfreund_N = mkN "Haus" freund_N ;
lin hausgeburt_N = mkN "Haus" geburt_N ;
lin hausherr_N = mkN "Haus" herr_N ;
lin haushund_N = mkN "Haus" hund_N ;
lin hauskatze_N = mkN "Haus" katze_N ;
lin hausfriede_N = mkN "Haus" (mkN "Friede" "Frieden" "Frieden" masculine) ;
lin hausgesinde_N = mkN "Haus" gesinde_N ;
lin haushalt_N = mkN "Haus" halt_N ;
lin hauskreis_N = mkN "Haus" kreis_N ;
lin hauslehrer_N = mkN "Haus" lehrer_N ;
lin hausmaedchen_N = mkN "Haus" maedchen_N ;
lin hausmutter_N = mkN "Haus" mutter_N ;
lin hausname_N = mkN "Haus" (mkN "Name" "Namen" "Namen" masculine) ;
lin hausnummer_N = mkN "Haus" nummer_N ;
lin hausschuh_N = mkN "Haus" schuh_N ;
lin haustier_N = mkN "Haus" tier_N ;
lin haustor_N = mkN "Haus" tor_N ;
lin haustuer_N = mkN "Haus" tuer_N ;
lin hausverbot_N = mkN "Haus" verbot_N ;
lin hauswand_N = mkN "Haus" wand_N ;
lin hauswein_N = mkN "Haus" wein_N ;
lin hauswirt_N = mkN "Haus" wirt_N ;
lin haselmaus_N = mkN "Hasel" maus__N ;
lin haselnuss_N = mkN "Hasel" nuss_N ;
lin hasenfuss_N = mkN "Hasen" fuss_N ;
lin haubenmeise_N = mkN "Hauben" meise_N ;
lin haubentaucher_N = mkN "Hauben" taucher_N ;
lin hautentzuendung_N = mkN "Haut" entzuendung_N ;
lin hauterkrankung_N = mkN "Haut" erkrankung_N ;
lin hautinfektion_N = mkN "Haut" infektion_N ;
lin hautkrankheit_N = mkN "Haut" krankheit_N ;
lin hautschicht_N = mkN "Haut" schicht_N ;
lin hautstoerung_N = mkN "Haut" stoerung_N ;
lin hautverletzung_N = mkN "Haut" verletzung_N ;
lin hautfarbe_N = changeCompoundN "Hautfarben" (mkN "Haut" farbe_N) ;
lin hautflaeche_N = mkN "Haut" flaeche_N ;
lin hautpartie_N = changeCompoundN "Hautpartien" (mkN "Haut" partie_N) ;
lin hautreaktion_N = changeCompoundN "Hautreaktion" (mkN "Haut" reaktion_N) ;
lin hautzelle_N = changeCompoundN "Hautzellen" (mkN "Haut" zelle_N) ;
lin heideherr_N = changeCompoundN "Heideherr" (mkN "Heide" herr_N) ;
lin heidelaeufer_N = mkN "Heide" laeufer_N ;
lin hefeinfektion_N = mkN "Hefe" infektion_N ;
lin hefezelle_N = changeCompoundN "Hefezellen" (mkN "Hefe" zelle_N) ;
lin heimfahrt_N = mkN "Heim" fahrt_N ;
lin heimreise_N = changeCompoundN "Heimreisen" (mkN "Heim" reise_N) ;
lin heimsieg_N = mkN "Heim" sieg_N ;
lin heimspiel_N = mkN "Heim" spiel_N ;
lin heimtier_N = mkN "Heim" tier_N ;
lin holzbank_N = mkN "Holz" bank_N ;
lin holzbecher_N = mkN "Holz" becher_N ;
lin holzhaus_N = mkN "Holz" haus_N ;
lin holzmoebel_N = mkN "Holz" moebel_N ;
lin holzweg_N = mkN "Holz" weg_N ;
lin himmelbett_N = mkN "Himmel" bett_N ;
lin himmelfahrt_N = mkN "Himmel" fahrt_N ;
lin himmelsleiter_N = mkN "Himmels" leiter_N ;
lin hochblatt_N = mkN "Hoch" blatt_N ;
lin hochbruecke_N = mkN "Hoch" bruecke_N ;
lin hochhaus_N = mkN "Hoch" haus_N ;
lin hochnebel_N = mkN "Hoch" nebel_N ;
lin hochofen_N = mkN "Hoch" ofen_N ;
lin hochschule_N = mkN "Hoch" schule_N ;
lin hochseil_N = mkN "Hoch" seil_N ;
lin hochstrasse_N = mkN "Hoch" strasse_N ;
lin hofhund_N = mkN "Hof" hund_N ;
lin hosenrolle_N = mkN "Hosen" rolle_N ;
lin hosentasche_N = mkN "Hosen" tasche_N ;
lin hundezelle_N = changeCompoundN "Hundezellen" (mkN "Hunde" zelle_N) ;
lin hochzeitsbild_N = mkN "Hochzeits" bild_N ;
lin hochzeitsfeier_N = mkN "Hochzeits" feier_N ;
lin hochzeitskleid_N = mkN "Hochzeits" kleid_N ;
lin hochzeitsreise_N = changeCompoundN "Hochzeitsreisen" (mkN "Hochzeits" reise_N) ;
lin hochzeitstag_N = mkN "Hochzeits" tag_N ;
lin hochzeitsgeschenk_N = mkN "Hochzeits" geschenk_N ;
lin hochzeitssuppe_N = changeCompoundN "Hochzeitssuppen" (mkN "Hochzeits" suppe_N) ;
lin hochzeitstorte_N = changeCompoundN "Hochzeitstorten" (mkN "Hochzeits" torte_N) ;
lin hosenrock_N = mkN "Hosen" rock_N ;
lin hosenschlitz_N = mkN "Hosen" schlitz_N ;
lin hosentraeger_N = mkN "Hosen" traeger_N ;
lin hundeblume_N = mkN "Hunde" blume_N ;
lin hundehuette_N = mkN "Hunde" huette_N ;
lin hundeleine_N = mkN "Hunde" leine_N ;
lin hunderasse_N = changeCompoundN "Hunderassen" (mkN "Hunde" rasse_N) ;
lin hundeschlitten_N = mkN "Hunde" schlitten_N ;
lin hundeschwanz_N = mkN "Hunde" schwanz_N ;
lin hundefell_N = mkN "Hunde" fell_N ;
...
lin hunds_rose_N = mkHyphenN "Hunds" rose_N ;
lin hundsaffe_N = mkN "Hunds" affe_N ;
lin hundsrose_N = mkN "Hunds" rose_N ;
lin hundszunge_N = mkN "Hunds" zunge_N ;
lin hungerast_N = mkN "Hunger" ast_N ;
lin hungerbrunnen_N = mkN "Hunger" brunnen_N ;
lin hungergrube_N = mkN "Hunger" grube_N ;
lin hungerhaken_N = mkN "Hunger" haken_N ;
lin hungerharke_N = mkN "Hunger" harke_N ;
lin hungerhocke_N = mkN "Hunger" hocke_N ;
lin hungerjahr_N = mkN "Hunger" jahr_N ;
lin hungerlohn_N = mkN "Hunger" lohn_N ;
lin hungerpflaume_N = mkN "Hunger" pflaume_N ;
lin hungerquelle_N = changeCompoundN "Hungerquellen" (mkN "Hunger" quelle_N) ;
lin hungerrechen_N = mkN "Hunger" rechen_N ;
lin hungerstein_N = mkN "Hunger" stein_N ;
lin hungerstreik_N = mkN "Hunger" streik_N ;
lin hungertod_N = mkN "Hunger" tod_N ;
lin hungertuch_N = mkN "Hunger" (mkN "Tuch" "Tücher" neuter) ;
lin hungerturm_N = mkN "Hunger" turm_N ;
lin hungerzwetschge_N = mkN "Hunger" zwetschge_N ;
lin hurenkind_N = mkN hure_N kind_N ;
lin hurensohn_N = mkN hure_N sohn_N ;
lin hustenmittel_N = mkN husten_N mittel_N ;
lin hustensaft_N = mkN husten_N saft_N ;
lin hutfahrer_N = mkN hut_N fahrer_N ;
lin hutmacher_N = mkN "Hut" (mkN "Macher" "Macher" masculine) ;
lin hutmacherin_N = mkN "Hut" (mkN "Macherin" "Macherinnen" feminine) ;
lin hybridantrieb_N = mkN hybrid_N antrieb_N ;
lin hybridauto_N = mkN hybrid_N auto_N ;
lin hybridbildung_N = mkN hybrid_N bildung_N ;
lin hybridfaktor_N = mkN hybrid_N faktor_N ;
lin hybridgen_N = mkN hybrid_N gen_N ;
lin hybridpartikel_N = mkN hybrid_N partikel_N ;
lin hybridpromotor_N = mkN hybrid_N promotor_N ;
lin hybridprotein_N = mkN hybrid_N protein_N ;
lin hybridrasse_N = changeCompoundN "Hybridrassen" (mkN hybrid_N rasse_N) ;
...
lin hydrierkatalysator_N = mkN "Hydrier" katalysator_N ;
lin hydrierungskatalysator_N = mkN "Hydrierungs" katalysator_N ;
lin hydrochloridsalz_N = mkN hydrochlorid_N salz_N ;
lin hydroxyfunktion_N = mkN "Hydroxy" funktion_N ;
lin hydroxygruppe_N = mkN "Hydroxy" gruppe_N ;
lin hydroxylfunktion_N = mkN "Hydroxyl" funktion_N ;
lin hydroxylgruppe_N = mkN "Hydroxyl" gruppe_N ;
lin hydroxyalkylgruppe_N = mkN "Hydroxyalkyl" gruppe_N ;
lin hydroxyfettsaeure_N = changeCompoundN "Hydroxyfettsäuren" (mkN "Hydroxy" fettsaeure_N) ;
lin hydroxylschutzgruppe_N = mkN "Hydroxyl" schutzgruppe_N ;
...
lin hydroxyethylstaerke_N = mkN "Hydroxyethyl" staerke_N ;
lin hydroxypropylcellulose_N = changeCompoundN "Hydroxypropylcellulosen" (mkN "Hydroxypropyl" cellulose_N) ;
lin hydroxypropylgruppe_N = mkN "Hydroxypropyl" gruppe_N ;
lin hydroxypropylmethylcellulose_N = changeCompoundN "Hydroxypropylmethylcellulosen" (mkN "Hydroxypropylmethyl" cellulose_N) ;
lin hydroxypropylstaerke_N = mkN "Hydroxypropyl" staerke_N ;
lin achselhoehle_N = mkN achsel_N hoehle_N ;
lin achteckstempel_N = mkN achteck_N stempel_N ;
lin achterbahn_N = mkN achter_N bahn_N ;
lin achtmonatskind_N = mkN "Achtmonats" kind_N ;
lin achtungserfolg_N = mkN "Achtung" erfolg_N ;
lin achillesferse_N = mkN "Achilles" ferse_N ;
lin achillessehne_N = mkN "Achilles" sehne_N ;
lin acetatpuffer_N = mkN "Acetat" puffer_N ;
lin acetatsaeure_N = changeCompoundN "Acetatsäuren" (mkN "Acetat" saeure_N) ;
lin acetessigsaeure_N = changeCompoundN "Acetessigsäuren" (mkN "Acetessig" saeure_N) ;
lin acetonitrilgradient_N = mkN "Acetonitril" gradient_N ;
lin acetonitrilkonzentration_N = mkN "Acetonitril" konzentration_N ;
lin acetoxygruppe_N = mkN "Acetoxy" gruppe_N ;
lin acetylcholinrezeptor_N = mkN "Acetylcholin" rezeptor_N ;
lin acetylgruppe_N = mkN "Acetyl" gruppe_N ;
lin acetylderivat_N = mkN acetyl_N derivat_N ;
lin acrylatpolymer_N = mkN acrylat_N polymer_N ;
lin acrylharzschicht_N = mkN acrylharz_N schicht_N ;
lin acylaminogruppe_N = mkN acyl_N aminogruppe_N ;
lin acylderivat_N = mkN acyl_N derivat_N ;
lin acylgruppe_N = mkN acyl_N gruppe_N ;
lin acylhalogenid_N = mkN acyl_N halogenid_N ;
lin acylierungskatalysator_N = mkN acylierung_N katalysator_N ;
lin acylierungsmittel_N = mkN acylierung_N mittel_N ;
lin acylkette_N = mkN acyl_N kette_N ;
lin acylkettenzusammensetzung_N = mkN acylkette_N zusammensetzung_N ;
lin acyloxygruppe_N = mkN "Acyloxy" gruppe_N ;
lin acylradikal_N = mkN acyl_N radikal_N ;
lin acylrest_N = mkN acyl_N rest_N ;
lin adenokarzinomzelle_N = mkN adenokarzinom_N zelle_N ;
lin adenosinderivat_N = mkN adenosine_N derivat_N ;
lin adenosinrezeptoragonist_N = mkN adenosine_N rezeptoragonist_N ;
lin adenovirusinfektion_N = mkN adenovirus_N infektion_N ;
lin adenovirusvektor_N = mkN adenovirus_N vektor_N ;
lin aderleitung_N = mkN ader_N leitung_N ;
lin adjektivphrase_N = mkN adjektiv_N phrase_N ;
lin adlerauge_N = mkN adler_N auge_N ;
lin adlerfarn_N = mkN adler_N farn_N ;
lin adlerhorst_N = mkN adler_N horst_N ;
lin adlernase_N = mkN adler_N nase_N ;
lin adlerstein_N = mkN adler_N stein_N ;
lin adressbuch_N = mkN adresse_N buch_N ;
lin adventgemeinde_N = mkN advent_N gemeinde_N ;
lin adventsonntag_N = mkN advent_N sonntag_N ;
lin adverbialadjektiv_N = mkN adverbial__N adjektiv_N ;
lin adverbialbestimmung_N = mkN adverbial__N bestimmung_N ;
lin adverbialklammer_N = mkN adverbial__N klammer_N ;
lin adverbialsatz_N = mkN adverbial__N satz_N ;
lin adverbklammer_N = mkN adverb_N klammer_N ;
lin adverbphrase_N = mkN adverb_N phrase_N ;
lin aehrenfeld_N = mkN aehre_N feld_N ;
lin aehrenlilie_N = mkN aehre_N lilie_N ;
lin abendessen_N = mkN abend_N essen_N ;
lin abendhimmel_N = mkN abend_N himmel__N ;
lin absolutadjektiv_N = mkN "Absolut" adjektiv_N ;
lin abaenderungsantrag_N = mkN abaenderung_N antrag_N ;
lin abgottschlange_N = mkN abgott_N schlange_N ;
lin abteilungsleiter_N = mkN abteilung_N leiter_N ;
lin abteilungsleiterin_N = mkN abteilung_N leiterin_N ;
lin abtritterker_N = mkN abtritt_N erker_N ;
lin ackergauchheil_N = mkN acker_N gauchheil_N ;
lin ackerweg_N = mkN acker_N weg_N ;
lin actionfilm_N = mkN "Action" film_N ;
lin activinantagonist_N = mkN "Activin" antagonist_N ;
lin adamantanylgruppe_N = mkN "Adamantanyl" gruppe_N ;
lin adamsapfel_N = mkN "Adams" apfel_N ;
lin additionsprodukt_N = mkN "Additions" produkt_N ;
lin additionssalz_N = mkN "Additions" salz_N ;
lin additionssystem_N = mkN "Additions" system_N ;
lin acrylverbindung_N = mkN "Acryl" verbindung_N ;
lin agrarbetrieb_N = mkN "Agrar" betrieb_N ;
lin agrarerzeugnis_N = mkN "Agrar" erzeugnis_N ;
lin agrarexport_N = mkN "Agrar" export_N ;
lin agrarpreis_N = mkN "Agrar" preis_N ;
lin agrarprodukt_N = mkN "Agrar" produkt_N ;
lin agrarreform_N = mkN "Agrar" reform_N ;
lin agrarstaat_N = mkN "Agrar" staat_N ;
lin agrarwissenschaft_N = mkN "Agrar" wissenschaft_N ;
lin ahnenbild_N = mkN ahne_N bild_N ;
lin ahnherr_N = mkN ahne_N herr_N ;
lin ahornsirup_N = mkN ahorn_N sirup_N ;
lin ahrwein_N = mkN "Ahr" wein_N ;
lin akanthusfries_N = mkN akanthus_N fries_N ;
lin agroforstsystem_N = mkN "Agroforst" system_N ;
...
lin abbruchfirma_N = mkN abbruch_N firma_N ;
lin abbruchgenehmigung_N = mkN abbruch_N genehmigung_N ;
lin abbruchhammer_N = mkN abbruch_N hammer_N ;
lin abbruchhaus_N = mkN abbruch_N haus_N ;
lin abbruchkante_N = mkN abbruch_N kante_N ;
lin abbruchmaterial_N = mkN abbruch_N material_N ;
...
lin antigenbindungsstelle_N = mkN antigen_N bindungsstelle_N ;
lin antigendeterminante_N = mkN antigen_N determinante_N ;
lin antigenkomponente_N = mkN antigen_N komponente_N ;
lin antigensequenz_N = mkN antigen_N sequenz_N ;
lin autobahnabfahrt_N = mkN autobahn_N abfahrt_N ;
lin autobahnauffahrt_N = mkN autobahn_N auffahrt_N ;
lin autobahnbruecke_N = mkN autobahn_N bruecke_N ;
lin autobahngebuehr_N = mkN autobahn_N gebuehr_N ;
lin autobahnkreuz_N = mkN autobahn_N kreuz_N ;
...
lin angststoerung_N = mkN angst_N stoerung_N ;
lin angststreifen_N = mkN angst_N streifen_N ;
lin angstzuschlag_N = mkN angst_N zuschlag_N ;
lin ampelfrau_N = mkN ampel_N frau_N ;
lin ampelkoalition_N = mkN ampel_N koalition_N ;
...
lin eidbruch_N = mkN "Eid" bruch_N ;
lin eidechsenleder_N = mkN "Eidechsen" leder_N ;
lin eiderente_N = mkN "Eider" ente_N ;
...
lin eigenheimbesitzer_N = mkN eigenheim_N besitzer_N ;
...
lin eisenatom_N = mkN "Eisen" atom_N ;
lin eisenerz_N = mkN "Eisen" erz_N ;
lin eisengehalt_N = mkN "Eisen"
  (mkN "Gehalt" "Gehalt" "Gehalt" "Gehaltes" "Gehalte" "Gehalten" neuter) ;
lin eisenhut_N = mkN "Eisen" hut_N ;
lin eisenrohr_N = mkN "Eisen" rohr_N ;
lin eisensalz_N = mkN "Eisen" salz_N ;
lin eisenverbindung_N = mkN "Eisen" verbindung_N ;
lin eisfach_N = mkN eis_N fach_N ;
lin eishoernchen_N = mkN eis_N hoernchen_N ;
lin eiskaffee_N = changeCompoundN "Eiskaffeen" (mkN eis_N kaffee_N) ;
lin eiskasten_N = mkN eis_N kasten_N ;
lin eiskeil_N = mkN eis_N keil_N ;
lin eiskratzer_N = mkN eis_N kratzer_N ;
lin eiskrem_N = mkN eis_N krem_N ;
lin eiskristall_N = mkN eis_N kristall_N ;
lin eiskugel_N = mkN eis_N kugel_N ;
lin eismaschine_N = mkN eis_N maschine_N ;
lin eismasse_N = mkN eis_N masse_N ;
lin eismeer_N = mkN eis_N meer_N ;
lin eismoewe_N = mkN eis_N moewe_N ;
lin eisnebel_N = mkN eis_N nebel_N ;
lin eispickel_N = mkN eis_N pickel_N ;
lin eispilz_N = mkN eis_N pilz_N ;
lin eisregen_N = mkN eis_N regen_N ;
lin eisscholle_N = mkN eis_N scholle_N ;
lin eistaucher_N = mkN eis_N taucher_N ;
lin eistee_N = changeCompoundN "Eisteen" (mkN eis_N tee_N) ;
lin eistuete_N = mkN eis_N tuete_N ;
lin eisvogel_N = mkN eis_N vogel_N ;
lin eiswein_N = mkN eis_N wein_N ;
lin eiswuerfel_N = mkN eis_N wuerfel_N ;
lin eiszapfen_N = mkN eis_N zapfen_N ;
lin eiszeit_N = mkN eis_N zeit_N ;
lin eisbaer_N = mkN eis_N baer_N ;
...
lin endphase_N = changeCompoundN "Endphasen" (mkN "End" phase_N) ;
lin endreim_N = mkN "End" reim_N ;
...
lin baltische_sprache_CN = S.mkCN baltisch_A sprache_N ;
lin germanische_sprache_CN = S.mkCN germanisch_A sprache_N ;
...
lin gewebeabstossungsreaktion_N = mkN gewebe_N abstossungsreaktion_N ;
...
lin gewebeplasminogenaktivator_N = mkN gewebe_N plasminogenaktivator_N ;
...
lin gewebsplasminogenaktivator_N = mkN "Gewebs" plasminogenaktivator_N ;
...
lin grundausstattung_N = mkN grund_N ausstattung_N ;
lin grundbestandteil_N = mkN grund_N bestandteil_N ;
lin grundbuch_N = mkN grund_N buch_N ;
lin herzattacke_N = mkN herz_N attacke_N ;
lin herzblatt_N = mkN herz_N blatt_N ;
...
lin kabinettskrieg_N = mkN "Kabinetts" krieg_N ;
lin kalbsbries_N = mkN "Kalbs" bries_N ;
...
lin maedchenname_N = changeCompoundN "Mädchennamen" (mkN "Mädchen" name_N) ;
...
lin maennersprache_N = changeCompoundN "Männersprachen" (mkN "Männer" sprache_N) ;
...
lin muttergewinde_N = changeCompoundN "Muttergewinden" (mkN "Mutter" gewinde_N) ;
lin mutterkorn_N = changeCompoundN "Mutterkorn" (mkN "Mutter" (mkN "Korn" "Korne" "Korn" neuter)) ;
...
lin pfefferminztee_N = changeCompoundN "Pfefferminzteen" (mkN pfefferminz_N tee_N) ;
...
lin plasminogenaktivator_N = mkN plasminogen_N aktivator_N ;
...
lin baugeruest_N = mkN "Bau" geruest_N ;
lin baugruppe_N = mkN "Bau" gruppe_N ;
lin bauhelm_N = mkN "Bau" helm_N ;
lin bauherr_N = mkN "Bau" herr_N ;
lin bauholz_N = mkN "Bau" holz_N ;
...
lin beichtstuhl_N = mkN beichte_N stuhl_N ;
lin beichtvater_N = mkN beichte_N vater_N ;
lin behaeltervorrichtung_N = mkN behaelter_N vorrichtung_N ;
...
lin bewerbungsfrist_N = mkN (changeCompoundN "Bewerbungs" bewerbung_N) frist_N ;
...
lin bergsteiger_N = mkN berg_N steiger_N ;
lin bergtapir_N = mkN berg_N tapir_N ;
lin bergulme_N = mkN berg_N ulme_N ;
lin bergwerk_N = mkN berg_N werk_N ;
lin besatzungsarmee_N = mkN besatzung_N armee_N ;
lin besatzungsmacht_N = mkN besatzung_N macht_N ;
lin besatzungsmitglied_N = mkN besatzung_N mitglied_N ;
...
lin bestimmungsbuch_N = mkN bestimmung_N buch_N ;
lin bestimmungsort_N = mkN bestimmung_N ort_N ;
lin bestimmungswort_N = mkN bestimmung_N wort_N ;
...
lin cadmiumsulfit_N = mkN "Cadmium" sulfit_N ;
lin camptothecinderivat_N = mkN "Camptothecin" derivat_N ;
...
lin dachbinder_N = mkN dach_N binder_N ;
lin dachfirst_N = mkN dach_N first_N ;
lin dachgiebel_N = mkN dach_N giebel_N ;
lin dachhase_N = mkN dach_N hase_N ;
lin dachkonstruktion_N = mkN dach_N konstruktion_N ;
lin dachlawine_N = mkN dach_N lawine_N ;
...
lin datenfernuebertragung_N = mkN "Daten" (mkN "Fernübertragung" "Fernübertragungen" feminine) ;
lin datenschuetzer_N = mkN "Daten" (mkN "Schützer" "Schützer" masculine) ;
lin datenverarbeitung_N = mkN "Daten" (mkN "Verarbeitung" "Verarbeitungen" feminine) ;
...
lin catch_visual_N = mkHyphenN "Catch" (mkN "Visual" "Visuals" neuter) ;
lin cd_brenner_N = mkHyphenN "CD" (mkN "Brenner" "Brenner" masculine) ;
lin cd_player_N = mkHyphenN "CD" (mkN "Player" "Player" masculine) ;
lin cd_rom_laufwerk_N = mkHyphenN "CD-ROM" (mkN "Laufwerk" "Laufwerke" neuter) ;
lin cd_spieler_N = mkHyphenN "CD" (mkN "Spieler" "Spieler" masculine) ;
lin charter_kolonie_N = mkHyphenN "Charter" (mkN "Kolonie" "Kolonien" feminine) ;
lin come_back_N = mkHyphenN "Come" (mkN "back" "backs" neuter) ;
lin coming_out_N = mkHyphenN "Coming" (mkN "out" "outs" neuter) ;
lin compact_disc_recorder_N = mkHyphenN "Compact-Disc" (mkN "Recorder" "Recorder" masculine) ;
lin costa_ricaner_9_N = mkHyphenN "Costa" (mkN "Ricaner" "Ricaner" masculine) ;
lin costa_ricanerin_5_N = mkHyphenN "Costa" (mkN "Ricanerin" "Ricanerinnen" feminine) ;
lin d_day_N = mkHyphenN "D" (mkN "Day" "Days" masculine) ;
lin d_zug_N = mkHyphenN "D" (mkN "Zug" "Züge" masculine) ;
lin dass_satz_1_N = mkHyphenN "daß" (mkN "Satz" "Sätze" masculine) ;
lin dass_satz_N = mkHyphenN "dass" (mkN "Satz" "Sätze" masculine) ;
lin day_trader_N = mkHyphenN "Day" (mkN "Trader" "Trader" masculine) ;
lin deja_vu_N = mkHyphenN "Déjà" (mkN "vu" "vus" neuter) ;
lin determinativ_kompositum_N = mkHyphenN "Determinativ" (mkN "Kompositum" "Komposita" neuter) ;
lin diplom_bibliothekar_N = mkHyphenN "Diplom" (mkN "Bibliothekar" "Bibliothekare" masculine) ;
lin diplom_bibliothekarin_N = mkHyphenN "Diplom" (mkN "Bibliothekarin" "Bibliothekarinnen" feminine) ;
lin diplom_biologe_N = mkHyphenN "Diplom" (mkN "Biologe" "Biologen" masculine) ;
lin diplom_chemiker_N = mkHyphenN "Diplom" (mkN "Chemiker" "Chemiker" masculine) ;
lin diplom_handelslehrer_N = mkHyphenN "Diplom" (mkN "Handelslehrer" "Handelslehrer" masculine) ;
lin diplom_physikerin_N = mkHyphenN "Diplom" (mkN "Physikerin" "Physikerinnen" feminine) ;
lin diplom_volkswirt_N = mkHyphenN "Diplom" (mkN "Volkswirt" "Volkswirte" masculine) ;
lin diplom_volkswirtin_N = mkHyphenN "Diplom" (mkN "Volkswirtin" "Volkswirtinnen" feminine) ;
lin domino_effekt_N = mkHyphenN "Domino" (mkN "Effekt" "Effekte" masculine) ;
lin doppel_t_eisen_N = mkHyphenN "Doppel-T" (mkN "Eisen" "Eisen" neuter) ;
lin drop_down_menue_N = mkHyphenN "Drop-down" (mkN "Menü" "Menüs" neuter) ;
lin dropdown_liste_N = mkHyphenN "Dropdown" (mkN "Liste" "Listen" feminine) ;
lin duty_free_shop_N = mkHyphenN "Duty-free" (mkN "Shop" "Shops" masculine) ;
lin dvb_t_receiver_N = mkHyphenN "DVB-T" (mkN "Receiver" "Receiver" masculine) ;
lin cdu_gefuehrt_A = regA "CDU-geführt" ;
lin costa_ricanisch_A = mk3A "costa-ricanisch" "costa-ricanischer" "costa-ricanischste" ;
lin e_book_N = mkHyphenN "E" (mkN "Book" "Books" neuter) ;
lin e_geige_N = mkHyphenN "E" (mkN "Geige" "Geigen" feminine) ;
lin e_gitarre_N = mkHyphenN "E" (mkN "Gitarre" "Gitarren" feminine) ;
lin e_learning_N = mkHyphenN "E" (mkN "Learning" "Learnings" neuter) ;
lin e_mail_adresse_N = mkHyphenN "E-Mail" (mkN "Adresse" "Adressen" "Adress" feminine) ;
lin e_nummer_N = mkHyphenN "E" (mkN "Nummer" "Nummern" feminine) ;
lin e_zine_N = mkHyphenN "E" (mkN "Zine" "Zines" neuter) ;
lin ego_shooter_N = mkHyphenN "Ego" (mkN "Shooter" "Shooter" masculine) ;
lin ein_euro_job_N = mkHyphenN "Ein-Euro" (mkN "Job" "Jobs" masculine) ;
lin erste_hilfe_kasten_N = mkHyphenN "Erste-Hilfe" (mkN "Kasten" "Kästen" masculine) ;
lin eu_osterweiterung_N = mkHyphenN "EU" (mkN "Osterweiterung" "Osterweiterungen" feminine) ;
lin ex_und_hopp_flasche_N = mkHyphenN "Ex-und-hopp" (mkN "Flasche" "Flaschen" feminine) ;
lin eye_liner_N = mkHyphenN "Eye" (mkN "Liner" "Liner" masculine) ;
lin f_faktor_N = mkHyphenN "F" (mkN "Faktor" "Faktoren" masculine) ;
lin f_loch_N = mkHyphenN "F" (mkN "Loch" "Löcher" neuter) ;
lin feed_back_N = mkHyphenN "Feed" (mkN "back" "backs" neuter) ;
lin fehlerstrom_schutzschalter_N = mkHyphenN "Fehlerstrom" (mkN "Schutzschalter" "Schutzschalter" masculine) ;
lin fitness_studio_N = mkHyphenN "Fitness" (mkN "Studio" "Studios" neuter) ;
lin fkk_strand_N = mkHyphenN "FKK" (mkN "Strand" "Strände" masculine) ;
lin flip_flop_N = mkHyphenN "Flip" (mkN "Flop" "Flops" masculine) ;
lin florida_waldkaninchen_N = mkHyphenN "Florida" (mkN "Waldkaninchen" "Waldkaninchen" neuter) ;
lin focus_visual_N = mkHyphenN "Focus" (mkN "Visual" "Visuals" neuter) ;
lin fourier_analyse_N = mkHyphenN "Fourier" (mkN "Analyse" "Analysen" feminine) ;
lin fourier_synthese_N = mkHyphenN "Fourier" (mkN "Synthese" "Synthesen" feminine) ;
lin fuenf_prozent_huerde_N = mkHyphenN "Fünf-Prozent" (mkN "Hürde" "Hürden" feminine) ;
lin fuerst_pless_horn_N = mkHyphenN "Fürst-Pless" (mkN "Horn" "Hörner" neuter) ;
lin full_time_job_N = mkHyphenN "Full-Time" (mkN "Job" "Jobs" masculine) ;
lin fulltime_job_N = mkHyphenN "Fulltime" (mkN "Job" "Jobs" masculine) ;
lin fussball_em_N = mkHyphenN "Fußball" (mkN "EM" "EMs" feminine) ;
lin fussball_europameisterschaft_N = mkHyphenN "Fußball" (mkN "Europameisterschaft" "Europameisterschaften" feminine) ;
lin g_punkt_N = mkHyphenN "G" (mkN "Punkt" "Punkte" masculine) ;
lin geschirr_reiniger_N = mkHyphenN "Geschirr" (mkN "Reiniger" "Reiniger" masculine) ;
lin gewinn_und_verlust_rechnung_N = mkHyphenN "Gewinn-und-Verlust" (mkN "Rechnung" "Rechnungen" feminine) ;
lin golgi_apparat_N = mkHyphenN "Golgi" (mkN "Apparat" "Apparate" masculine) ;
lin golgi_vesikel_N = mkHyphenN "Golgi" (mkN "Vesikel" "Vesikel" neuter) ;
lin golgi_zisterne_N = mkHyphenN "Golgi" (mkN "Zisterne" "Zisternen" feminine) ;
lin guinea_bissauer_N = mkHyphenN "Guinea" (mkN "Bissauer" "Bissauer" masculine) ;
lin guinea_bissauerin_N = mkHyphenN "Guinea" (mkN "Bissauerin" "Bissauerinnen" feminine) ;
lin half_pipe_N = mkHyphenN "Half" (mkN "Pipe" "Pipes" feminine) ;
lin hals_nasen_ohren_aerztin_N = mkHyphenN "Hals-Nasen-Ohren" (mkN "Ärztin" "Ärztinnen" feminine) ;
lin hals_nasen_ohren_arzt_N = mkHyphenN "Hals-Nasen-Ohren" (mkN "Arzt" "Ärzte" masculine) ;
lin hardware_abstraktions_schicht_N = mkHyphenN "Hardware-Abstraktions" (mkN "Schicht" "Schichten" feminine) ;
lin hausa_frau_N = mkHyphenN "Hausa" (mkN "Frau" "Frauen" feminine) ;
lin hecken_ausdruck_N = mkHyphenN "Hecken" (mkN "Ausdruck" "Ausdrücke" masculine) ;
lin hemi_motor_N = mkHyphenN "HEMI" (mkN "Motor" "Motoren" masculine) ;
lin herbig_haro_objekt_N = mkHyphenN "Herbig-Haro" (mkN "Objekt" "Objekte" neuter) ;
lin hole_in_one_N = mkHyphenN "Hole-in" (mkN "one" "ones" neuter) ;
lin hula_hoop_reifen_N = mkHyphenN "Hula-Hoop" (mkN "Reifen" "Reifen" masculine) ;
lin i_tuepfelchen_N = mkHyphenN "i" (mkN "Tüpfelchen" "Tüpfelchen" neuter) ;
lin ic_analyse_N = mkHyphenN "IC" (mkN "Analyse" "Analysen" feminine) ;
lin ich_ag_N = mkHyphenN "Ich" (mkN "AG" "AGs" feminine) ;
lin ich_aktiengesellschaft_N = mkHyphenN "Ich" (mkN "Aktiengesellschaft" "Aktiengesellschaften" feminine) ;
lin ich_laut_N = mkHyphenN "Ich" (mkN "Laut" "Laute" masculine) ;
lin inline_skate_N = mkHyphenN "Inline" (mkN "Skate" "Skates" masculine) ;
lin intercity_express_N = mkHyphenN "Intercity" (mkN "Express" "Expresse" masculine) ;
lin ip_adresse_N = mkHyphenN "IP" (mkN "Adresse" "Adressen" "Adress" feminine) ;
lin it_service_N = mkHyphenN "IT" (mkN "Service" "Services" masculine) ;
lin isbn_nummer_N = mkHyphenN "ISBN" (mkN "Nummer" "Nummern" feminine) ;
lin it_system_N = mkHyphenN "IT" (mkN "System" "Systeme" neuter) ;
lin italo_western_N = mkHyphenN "Italo" (mkN "Western" "Western" masculine) ;
lin jojo_effekt_N = mkHyphenN "Jojo" (mkN "Effekt" "Effekte" masculine) ;
lin jumbo_jet_N = mkHyphenN "Jumbo" (mkN "Jet" "Jets" masculine) ;
lin kam_tai_sprache_N = mkHyphenN "Kam-Tai" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin kap_verdier_N = mkHyphenN "Kap" (mkN "Verdier" "Verdier" masculine) ;
lin kap_verdierin_N = mkHyphenN "Kap" (mkN "Verdierin" "Verdierinnen" feminine) ;
lin key_visual_N = mkHyphenN "Key" (mkN "Visual" "Visuals" neuter) ;
lin khoisan_sprache_N = mkHyphenN "Khoisan" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin kick_off_meeting_N = mkHyphenN "Kick-off" (mkN "Meeting" "Meetings" neuter) ;
lin kick_off_N = mkHyphenN "Kick" (mkN "off" "offs" masculine) ;
lin knock_out_N = mkHyphenN "Knock" (mkN "out" "outs" masculine) ;
lin kompetenz_kompetenz_N = mkHyphenN "Kompetenz" (mkN "Kompetenz" "Kompetenzen" feminine) ;
lin kopf_an_kopf_rennen_N = mkHyphenN "Kopf-an-Kopf" (mkN "Rennen" "Rennen" neuter) ;
lin kosovo_albaner_N = mkHyphenN "Kosovo" (mkN "Albaner" "Albaner" masculine) ;
lin kosovo_albanerin_N = mkHyphenN "Kosovo" (mkN "Albanerin" "Albanerinnen" feminine) ;
lin kreol_sprache_N = mkHyphenN "Kreol" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin kuh_roehrling__N = mkHyphenN "Kuh" (mkN "Röhrling" "Röhrlinge" masculine) ;
lin kurzhorn_kroetenechse_N = mkHyphenN "Kurzhorn" (mkN "Krötenechse" "Krötenechsen" feminine) ;
lin la_ola_welle_N = mkHyphenN "La-Ola" (mkN "Welle" "Wellen" feminine) ;
lin lan_party_N = mkHyphenN "LAN" (mkN "Party" "Partys" feminine) ;
lin lehrer_schwa_N = mkHyphenN "Lehrer" (mkN "Schwa" "Schwas" neuter) ;
lin linux_kernel_N = mkHyphenN "Linux" (mkN "Kernel" "Kernel" masculine) ;
lin live_reportage_N = mkHyphenN "Live" (mkN "Reportage" "Reportagen" feminine) ;
lin live_stream_N = mkHyphenN "Live" (mkN "Stream" "Streams" masculine) ;
lin lorentz_kraft_N = mkHyphenN "Lorentz" (mkN "Kraft" "Kräfte" feminine) ;
lin luzerne_pellet_N = mkHyphenN "Luzerne" (mkN "Pellet" "Pellets" masculine) ;
lin maedesuess_perlmutterfalter_N = mkHyphenN "Mädesüß" (mkN "Perlmutterfalter" "Perlmutterfalter" masculine) ;
lin magellan_pinguin_N = mkHyphenN "Magellan" (mkN "Pinguin" "Pinguine" masculine) ;
lin magerrasen_perlmutterfalter_N = mkHyphenN "Magerrasen" (mkN "Perlmutterfalter" "Perlmutterfalter" masculine) ;
lin mak_wert_N = mkHyphenN "MAK" (mkN "Wert" "Werte" masculine) ;
lin martial_arts_film_N = mkHyphenN "Martial-Arts" (mkN "Film" "Filme" masculine) ;
lin maya_sprache_N = mkHyphenN "Maya" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin menage_a_trois_N = mkHyphenN "Ménage-à" (mkN "trois" "trois" feminine) ;
lin mensch_maschine_schnittstelle_N = mkHyphenN "Mensch-Maschine" (mkN "Schnittstelle" "Schnittstellen" feminine) ;
lin mensch_maschine_system_N = mkHyphenN "Mensch-Maschine" (mkN "System" "Systeme" neuter) ;
lin mersenne_primzahl_N = mkHyphenN "Mersenne" (mkN "Primzahl" "Primzahlen" feminine) ;
lin michel_katalog_N = mkHyphenN "Michel" (mkN "Katalog" "Kataloge" masculine) ;
lin min_dialekt_N = mkHyphenN "Min" (mkN "Dialekt" "Dialekte" masculine) ;
lin mini_mental_status_test_N = mkHyphenN "Mini-Mental-Status" (mkN "Test" "Tests" masculine) ;
lin minimalmengen_kuehlschmierung_N = mkHyphenN "Minimalmengen" (mkN "Kühlschmierung" "Kühlschmierungen" feminine) ;
lin morio_muskat_N = mkHyphenN "Morio" (mkN "Muskat" "Muskats" masculine) ;
lin morpho_phonem_N = mkHyphenN "Morpho" (mkN "Phonem" "Phoneme" neuter) ;
lin mp3_player_N = mkHyphenN "MP3" (mkN "Player" "Player" masculine) ;
lin mu_err_pilz_N = mkHyphenN "Mu-Err" (mkN "Pilz" "Pilze" masculine) ;
lin mueller_thurgau_N = mkHyphenN "Müller" (invarN "Thurgau" masculine) ;
lin mund_zu_mund_beatmung_N = mkHyphenN "Mund-zu-Mund" (mkN "Beatmung" "Beatmungen" feminine) ;
lin mut_a_ehe_N = mkHyphenN "Mut'a" (mkN "Ehe" "Ehen" feminine) ;
lin mutter_kind_parkplatz_N = mkHyphenN "Mutter-Kind" (mkN "Parkplatz" "Parkplätze" masculine) ;
lin n_gramm_2_N = mkHyphenN "n" (mkN "Gramm" "Gramme" neuter) ;
lin n_gramm_N = mkHyphenN "N" (mkN "Gramm" "Gramme" neuter) ;
lin nc_management_system_N = mkHyphenN "NC-Management" (mkN "System" "Systeme" neuter) ;
lin niederlaendische_antillen_gulden_N = mkHyphenN "Niederländische-Antillen" (mkN "Gulden" "Gulden" masculine) ;
lin niger_kongo_sprache_N = mkHyphenN "Niger-Kongo" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin no_go_area_N = mkHyphenN "No-go" (mkN "Area" "Areas" feminine) ;
lin no_go_N = mkHyphenN "No" (mkN "Go" "Gos" neuter) ;
lin nordrhein_westfaelin_N = mkHyphenN "Nordrhein" (mkN "Westfälin" "Westfälinnen" feminine) ;
lin nordrhein_westfale_N = mkHyphenN "Nordrhein" (mkN "Westfale" "Westfalen" masculine) ;
lin one_night_stand_N = mkHyphenN "One-Night" (mkN "Stand" "Stands" masculine) ;
lin one_way_flug_N = mkHyphenN "One-Way" (mkN "Flug" "Flüge" masculine) ;
lin online_woerterbuch_N = mkHyphenN "Online" (mkN "Wörterbuch" "Wörterbücher" neuter) ;
lin orang_utan_N = mkHyphenN "Orang" (mkN "Utan" "Utans" masculine) ;
lin ortsnamen_grundwort_N = mkHyphenN "Ortsnamen" (mkN "Grundwort" "Grundwörter" neuter) ;
lin ovo_lacto_vegetarier_N = mkHyphenN "Ovo-Lacto" (mkN "Vegetarier" "Vegetarier" masculine) ;
lin ovo_lacto_vegetarierin_N = mkHyphenN "Ovo-Lacto" (mkN "Vegetarierin" "Vegetarierinnen" masculine) ;
lin palato_alveolar_N = mkHyphenN "Palato" (mkN "Alveolar" "Alveolare" masculine) ;
lin pantry_kueche_N = mkHyphenN "Pantry" (mkN "Küche" "Küchen" feminine) ;
lin papua_neuguineer_N = mkHyphenN "Papua" (mkN "Neuguineer" "Neuguineer" masculine) ;
lin papua_neuguineerin_N = mkHyphenN "Papua" (mkN "Neuguineerin" "Neuguineerinnen" feminine) ;
lin pen___paper_rollenspiel_N = mkHyphenN "Pen-&-Paper" (mkN "Rollenspiel" "Rollenspiele" neuter) ;
lin ph_wert_N = mkHyphenN "pH" (mkN "Wert" "Werte" masculine) ;
lin pidgin_sprache_N = mkHyphenN "Pidgin" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin pivot_grammatik_N = mkHyphenN "Pivot" (mkN "Grammatik" "Grammatiken" feminine) ;
lin planck_aera_N = mkHyphenN "Planck" (mkN "Ära" "Ären" feminine) ;
lin platzhalter_element_N = mkHyphenN "Platzhalter" (mkN "Element" "Elemente" neuter) ;
lin polo_shirt_N = mkHyphenN "Polo" (mkN "Shirt" "Shirts" neuter) ;
lin portmanteau_morphem_N = mkHyphenN "Portmanteau" (mkN "Morphem" "Morpheme" neuter) ;
lin possessiv_kompositum_N = mkHyphenN "Possessiv" (mkN "Kompositum" "Komposita" neuter) ;
lin preis_leistungs_verhaeltnis_N = mkHyphenN "Preis-Leistungs" (mkN "Verhältnis" "Verhältnisse" neuter) ;
lin pro_adverb_N = mkHyphenN "Pro" (mkN "Adverb" "Adverbien" neuter) ;
lin pro_form_N = mkHyphenN "Pro" (mkN "Form" "Formen" feminine) ;
lin prokrustes_bett_N = mkHyphenN "Prokrustes" (mkN "Bett" "Betten" neuter) ;
lin proto_sprache_N = mkHyphenN "Proto" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin pulitzer_preis_N = mkHyphenN "Pulitzer" (mkN "Preis" "Preise" masculine) ;
lin put_option_N = mkHyphenN "Put" (mkN "Option" "Optionen" feminine) ;
lin quasi_synonym_N = mkHyphenN "Quasi" (mkN "Synonym" "Synonyme" neuter) ;
lin rating_agentur_N = mkHyphenN "Rating" (mkN "Agentur" "Agenturen" feminine) ;
lin ratten_lungenwurm_N = mkHyphenN "Ratten" (mkN "Lungenwurm" "Lungenwürmer" masculine) ;
lin remi_haar_N = mkHyphenN "Remi" (mkN "Haar" "Haare" neuter) ;
lin rezipienten_passiv_N = mkHyphenN "Rezipienten" (mkN "Passiv" "Passive" neuter) ;
lin rheinland_pfaelzer_N = mkHyphenN "Rheinland" (mkN "Pfälzer" "Pfälzer" masculine) ;
lin rosmarin_seidelbast_N = mkHyphenN "Rosmarin" (mkN "Seidelbast" "Seidelbaste" masculine) ;
lin rot_kreuz_kasten_N = mkHyphenN "Rot-Kreuz" (mkN "Kasten" "Kästen" masculine) ;
lin rss_feed_N = mkHyphenN "RSS" (mkN "Feed" "Feeds" masculine) ;
lin s_bahn_N = mkHyphenN "S" (mkN "Bahn" "Bahnen" feminine) ;
lin s_bahnhof_N = mkHyphenN "S" (mkN "Bahnhof" "Bahnhöfe" masculine) ;
lin s_o_tomeer_N = mkN "São-Toméer" "São-Toméer" "São-Toméer" masculine ;
lin s_o_tomeerin_N = mkN "São-Toméerin" "São-Toméerinnen" "São-Toméerin" feminine ;
lin sachsen_anhalter_N = mkHyphenN "Sachsen" (mkN "Anhalter" "Anhalter" masculine) ;
lin saeure_base_reaktion_N = changeCompoundN "Säure-Base-Reaktion" (mkHyphenN "Säure-Base" (mkN "Reaktion" "Reaktionen" feminine)) ;
lin sag_wort_N = mkHyphenN "Sag" (mkN "Wort" "Wörter" neuter) ;
lin san_marinese_N = mkHyphenN "San" (mkN "Marinese" "Marinesen" masculine) ;
lin san_marinesin_N = mkHyphenN "San" (mkN "Marinesin" "Marinesinnen" feminine) ;
lin sankt_gallener_5_N = mkHyphenN "Sankt" (mkN "Gallener" "Gallener" masculine) ;
lin sankt_gallenerin_7_N = mkHyphenN "Sankt" (mkN "Gallenerin" "Gallenerinnen" feminine) ;
lin sankt_galler_9_N = mkHyphenN "Sankt" (mkN "Galler" "Galler" masculine) ;
lin sankt_gallerin_4_N = mkHyphenN "Sankt" (mkN "Gallerin" "Gallerinnen" feminine) ;
lin saudi_araber_N = mkHyphenN "Saudi" (mkN "Araber" "Araber" masculine) ;
lin saudi_araberin_N = mkHyphenN "Saudi" (mkN "Araberin" "Araberinnen" feminine) ;
lin schema_modell_N = mkHyphenN "Schema" (mkN "Modell" "Modelle" neuter) ;
lin schleswig_holsteiner_N = mkHyphenN "Schleswig" (mkN "Holsteiner" "Holsteiner" masculine) ;
lin schleswig_holsteinerin_N = mkHyphenN "Schleswig" (mkN "Holsteinerin" "Holsteinerinnen" feminine) ;
lin schluss_strich_N = mkHyphenN "Schluss" (mkN "Strich" "Striche" masculine) ;
lin schmuckblatt_telegramm_N = mkHyphenN "Schmuckblatt" (mkN "Telegramm" "Telegramme" neuter) ;
lin schranken_schranke_N = mkHyphenN "Schranken" (mkN "Schranke" "Schranken" feminine) ;
lin schwa_elision_N = changeCompoundN "Schwa-Elision" (mkHyphenN "Schwa" (mkN "Elision" "Elisionen" feminine)) ;
lin sex_video_N = mkHyphenN "Sex" (mkN "Video" "Videos" neuter) ;
lin si_einheit_N = mkHyphenN "SI" (mkN "Einheit" "Einheiten" feminine) ;
lin siegbahn_einheit_N = mkHyphenN "Siegbahn" (mkN "Einheit" "Einheiten" feminine) ;
lin sierra_leoner_N = mkHyphenN "Sierra" (mkN "Leoner" "Leoner" masculine) ;
lin sierra_leonerin_N = mkHyphenN "Sierra" (mkN "Leonerin" "Leonerinnen" feminine) ;
lin silberfleck_perlmutterfalter_N = mkHyphenN "Silberfleck" (mkN "Perlmutterfalter" "Perlmutterfalter" masculine) ;
lin software_entwickler_N = mkHyphenN "Software" (mkN "Entwickler" "Entwickler" masculine) ;
lin software_entwicklerin_N = mkHyphenN "Software" (mkN "Entwicklerin" "Entwicklerinnen" feminine) ;
lin sokolski_eroeffnung_N = mkHyphenN "Sokolski" (mkN "Eröffnung" "Eröffnungen" "Eröffnungs" feminine) ;
lin sri_lanker_0_N = mkHyphenN "Sri" (mkN "Lanker" "Lanker" masculine) ;
lin sri_lankerin_3_N = mkHyphenN "Sri" (mkN "Lankerin" "Lankerinnen" feminine) ;
lin ss_mann_N = mkHyphenN "SS" (mkN "Mann" "Männer" masculine) ;
lin stern_steinbrech_N = mkHyphenN "Stern" (mkN "Steinbrech" "Steinbreche" masculine) ;
lin stimmzettel_ergebnis_N = mkHyphenN "Stimmzettel" (mkN "Ergebnis" "Ergebnisse" neuter) ;
lin sturm_und_drang_zeit_N = mkHyphenN "Sturm-und-Drang" (mkN "Zeit" "Zeiten" feminine) ;
lin super_acht_farbfilm_N = mkHyphenN "Super-Acht" (mkN "Farbfilm" "Farbfilme" masculine) ;
lin t_bone_steak_N = mkHyphenN "T-Bone" (mkN "Steak" "Steaks" "Steak" neuter) ;
lin t_eisen_N = mkHyphenN "T" (mkN "Eisen" "Eisen" "Eisen" neuter) ;
lin t_shirt_N = mkHyphenN "T" (mkN "Shirt" "Shirts" "Shirt" neuter) ;
lin t_stueck_N = mkHyphenN "T" (mkN "Stück" "Stücke" "Stück" neuter) ;
lin t_tauri_stern_N = mkHyphenN "T-Tauri" (mkN "Stern" "Sterne" "Stern" masculine) ;
lin tag_und_nacht_gleiche_N = mkHyphenN "Tag-und-Nacht" (mkN "Gleiche" "Gleichen" "Gleichen" feminine) ;
lin tai_kadai_sprache_N = mkHyphenN "Tai-Kadai" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin tee_ei_N = mkHyphenN "Tee" (mkN "Ei" "Eier" "Ei" neuter) ;
lin tete_a_tete_N = mkHyphenN "Tête-à" (mkN "Tête" "Têtes" "Têten" neuter) ;
lin to_do_liste_N = mkHyphenN "To-do" (mkN "Liste" "Listen" "Listen" feminine) ;
lin top_level_domain_N = mkHyphenN "Top-Level" (mkN "Domain" "Domains" "Domain" feminine) ;
lin transvaal_ndebele_N = mkHyphenN "Transvaal" (mkN "Ndebele" "Ndebele" "Ndebelen" masculine) ;
lin tup__sprache_N = mkHyphenN "Tupí" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin tupi_sprache_N = mkHyphenN "Tupi" (mkN "Sprache" "Sprachen" "Sprach" feminine) ;
lin tv_duell_N = mkHyphenN "TV" (mkN "Duell" "Duelle" "Duell" neuter) ;
lin tv_spendengala_N = mkHyphenN "TV" (mkN "Spendengala" "Spendengalas" "Spendengala" feminine) ;
lin tv_turm_N = mkHyphenN "TV" (mkN "Turm" "Türme" "Turm" masculine) ;
lin type_token_ratio_N = mkHyphenN "Type-Token" (mkN "Ratio" "Ratios" "Ratio" feminine) ;
lin ufer_wolfstrapp_N = mkHyphenN "Ufer" (mkN "Wolfstrapp" "Wolfstrappe" "Wolfstrapp" masculine) ;
lin un_resolution_N = mkHyphenN "UN" (mkN "Resolution" "Resolutionen" "Resolution" feminine) ;
lin us_amerikaner_N = mkHyphenN "US" (mkN "Amerikaner" "Amerikaner" "Amerikaner" masculine) ;
lin us_amerikanerin_N = mkHyphenN "US" (mkN "Amerikanerin" "Amerikanerinnen" "Amerikanerin" feminine) ;
lin us_bundesstaat_N = mkHyphenN "US" (mkN "Bundesstaat" "Bundesstaaten" "Bundesstaat" masculine) ;
lin us_dollar_N = mkHyphenN "US" (mkN "Dollar" "Dollars" "Dollar" masculine) ;
lin usb_stick_N = mkHyphenN "USB" (mkN "Stick" "Sticks" "Stick" masculine) ;
lin user_id_N = mkHyphenN "User" (mkN "ID" "IDs" "ID" feminine) ;
lin van_de_graaff_generator_N = mkHyphenN "Van-de-Graaff" (mkN "Generator" "Generatoren" "Generator" masculine) ;
lin victory_zeichen_N = mkHyphenN "Victory" (mkN "Zeichen" "Zeichen" "Zeichen" neuter) ;
lin vierzehnpunkt_marienkaefer_N = mkHyphenN "Vierzehnpunkt" (mkN "Marienkäfer" "Marienkäfer" "Marienkäfer" masculine) ;
lin vokuhila_frisur_N = mkHyphenN "Vokuhila" (mkN "Frisur" "Frisuren" "Frisur" feminine) ;
lin wasser_mohrenfalter_N = mkHyphenN "Wasser" (mkN "Mohrenfalter" "Mohrenfalter" "Mohrenfalter" masculine) ;
lin weissspitzen_riffhai_N = mkHyphenN "Weißspitzen" (mkN "Riffhai" "Riffhaie" "Riffhai" masculine) ;
lin wem_fall_N = mkHyphenN "Wem" (mkN "Fall" "Fälle" "Fall" masculine) ;
lin wen_fall_N = mkHyphenN "Wen" (mkN "Fall" "Fälle" "Fall" masculine) ;
lin wer_fall_N = mkHyphenN "Wer" (mkN "Fall" "Fälle" "Fall" masculine) ;
lin wes_fall_N = mkHyphenN "Wes" (mkN "Fall" "Fälle" "Fall" masculine) ;
lin wessen_fall_N = mkHyphenN "Wessen" (mkN "Fall" "Fälle" "Fall" masculine) ;
lin wiesen_sauerampfer_N = mkHyphenN "Wiesen" (mkN "Sauerampfer" "Sauerampfer" "Sauerampfer" masculine) ;
lin wortfamilien_woerterbuch_N = mkHyphenN "Wortfamilien" (mkN "Wörterbuch" "Wörterbücher" "Wörterbuch" neuter) ;
lin vis_a_vis_Adv = mkAdv "vis-à-vis" ;
lin bild_austast_synchronsignal_N = mkHyphenN "Bild-Austast" (mkN "Synchronsignal" "Synchronsignale" "Synchronsignal" neuter) ;
lin bird_eroeffnung_N = mkHyphenN "Bird" (mkN "Eröffnung" "Eröffnungen" "Eröffnungs" feminine) ;
lin bootsmanns_maaten_pfeife_N = mkHyphenN "Bootsmanns-Maaten" (mkN "Pfeife" "Pfeifen" "Pfeifen" feminine) ;
lin brauen_glattstirnkaiman_N = mkHyphenN "Brauen" (mkN "Glattstirnkaiman" "Glattstirnkaimane" "Glattstirnkaiman" masculine) ;
lin brenn_nessel_N = mkHyphenN "Brenn" (mkN "Nessel" "Nesseln" "Nessel" feminine) ;
lin brombeer_perlmutterfalter_N = mkHyphenN "Brombeer" (mkN "Perlmutterfalter" "Perlmutterfalter" "Perlmutterfalter" masculine) ;
lin c_kommando_N = mkHyphenN "C" (mkN "Kommando" "Kommandos" "Kommando" neuter) ;
lin fugen_s_N = mkHyphenN "Fugen" (invarN "s" neuter) ;
lin genitiv_s_N = mkHyphenN "Genitiv" (invarN "s" neuter) ;
lin super_acht_film_N = mkHyphenN "Super-Acht" (mkN "Film" "Filme" "Film" masculine) ;
lin synthese_index_N = mkHyphenN "Synthese" (mkN "Index" "Indices" "Index" masculine) ;
lin xenon_lampe_N = mkHyphenN "Xenon" (mkN "Lampe" "Lampen" "Lampen" feminine) ;
...
lin immuneffektorzelle_N = mkN "Immuneffektor" (mkN "Zelle" "Zellen" "Zell" feminine) ;
...
lin jadebaum_N = mkN "Jade" (mkN "Baum" "Bäume" masculine) ;
lin jammertag_N = mkN "Jammer" (mkN "Tag" "Tage" masculine) ;
lin jammertal_N = mkN "Jammer" (mkN "Tal" "Täler" neuter) ;
lin jawort_N = mkN "Ja" (mkN "Wort" "Worte" neuter) ;
lin jeanshose_N = mkN "Jeans" (mkN "Hose" "Hosen" feminine) ;
lin jodeldiplom_N = mkN "Jodel" (mkN "Diplom" "Diplome" neuter) ;
lin juckpulver_N = mkN "Juck" (mkN "Pulver" "Pulver" neuter) ;
lin judaskuss_N = mkN "Judas" (mkN "Kuss" "Küsse" masculine) ;
lin judasohr_N = mkN "Judas" (mkN "Ohr" "Ohren" neuter) ;
lin jugendamt_N = mkN "Jugend" (mkN "Amt" "Ämter" neuter) ;
lin jugendbuch_N = mkN "Jugend" (mkN "Buch" "Bücher" neuter) ;
lin jugendfilm_N = mkN "Jugend" (mkN "Film" "Filme" masculine) ;
lin jugendsprache_N = mkN "Jugend" (mkN "Sprache" "Sprachen" feminine) ;
